  ...
  const features = [
    {
      ...
      description: "Designing scalable microservices and RESTful APIs that handle millions of requests efficiently.",
    },
    {
      icon: Zap,
      title: "Performance Optimization",
      description: "Improving system performance by 30%+ through caching strategies and database optimization.",
    },
    {
      icon: Palette,
      title: "Payment Systems Integration",
      description: "Integrating 10+ payment gateways and handling 35K+ daily transactions securely.",
    },
    {
      icon: Users,
      title: "Team Leadership",
      description: "Mentoring junior developers and enhancing team productivity through best practices.",
    },
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Backend Engineer specializing in building scalable, cloud-native systems using Laravel, Node.js, and AWS.
              Expert in API performance optimization and microservices architecture.
            </p>
            <p className="text-muted-foreground mb-6 leading-relaxed">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="aspect-square rounded-xl bg-gradient-to-br from-green-500 to-teal-500 p-4 text-white">
                <div className="text-center h-full flex flex-col justify-center">
                  <div className="text-3xl mb-2">💳</div>
                  <p className="text-sm font-medium">Payment Systems</p>
                </div>
              </div>
